      ...
      <div className='container'>
        <div className='footer-logo'>
          ...
          <h2 className='footer-text'>
            Мережа освітніх закладів «Пізнайки-Розвивайки» це сім приватних закладів у місті
            Вишгороді (ліцей, дві початкові школи, дитячий садочок, репетиторський центр, група
            подовженого дня).
          </h2>
        </div>
