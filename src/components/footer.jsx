			...
			<div className='container'>
				<div className='footer-logo'>
					...
					<h2 className='footer-text'>
						Мережа освітніх закладів «Пізнайки-Розвивайки» це сім приватних
						закладів у місті Вишгороді (ліцей, дві початкові школи, дитячий
						садочок, репетиторський центр, група подовженого дня).
					</h2>
				</div>
				<div className='flex flex-col justify-between gap-4'>
					...
					<nav className='footer-nav'>
						<ul className='footer-list'>
							...
							<li>
								<Modal
									trigger={<button className='footer-link'>Вакансії</button>}
								>
									<Vacancy />
								</Modal>
							</li>
