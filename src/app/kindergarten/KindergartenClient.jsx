...
export default function KindergartenClient() {
	useEffect(() => {
				...
				<div className='container'>
					...
					<div className='hero-text__container'>
						...
						<p className='page-subtitle'>
							Відкритий у 2019р в новому житловому комплексі ЖК «Ярославичі-1»
							міста Вишгород.
						</p>
					...
					<div className='flex flex-col md:flex-row gap-4'>
						<div className='text-center md:text-left self-center max-w-full xs:max-w-[90%] 880:max-w-[590px]'>
							...
							<p className='my-6 sm:mt-10 sm:mb-7 text-2xl'>
								Та стандартам Міністерства освіти та науки України, про що
								свідчить{' '}
								<Link
									href={
										'https://koda.gov.ua/normdoc/pro-vidachu-licenzii-na-provadzhennya-os-32/'
									}
									target='_blank'
							...
							<p className='text-2xl'>
								...
								<Link
									href={
										'https://mon.gov.ua/osvita-2/doshkilna-osvita-2/programi-rozvitku-ditey'
									}
									target='_blank'
									className='text-[var(--accentColor)] hover:underline'
								>
						...
						<div className='relative'>
							<Image
								src={kids}
								alt='Щасливі дітки'
								className='md:scale-140 relative md:left-[20%]'
								quality={100}
							/>
			...
			<section className='kinder-services'>
				<div className='container'>
					...
					<Image
						aria-hidden
						src={puzzleOrange}
						alt='Помаранчевий пазл'
						className='float'
					/>
					<Image
						aria-hidden
						src={puzzlePiece}
						alt='Оранжевий шматочок пазлу'
						className='float'
					/>
					...
					<ul className='kinder-services__list'>
						...
						<li className='hoverable-item'>
							<span className='hoverable-item__inset'>
				...
				<div className='container'>
					...
					<ul className='kinder-benefits-list'>
						...
						<li>
							<Image
								src={details3}
								alt={`Інтер'єр приміщення садочку`}
								quality={100}
							/>
							<div>
								<h3>У приміщеннях зроблений сучасний ремонт</h3>
								<p>
									Cвітлі пастельні кольори, підлога ламінат з автономним
									опаленням, підключена система охорони та відео нагляду, усі
									меблі виготовлені по індивідуальному замовленню та з
									матеріалів, що мають сертифікати відповідності
								</p>
							</div>
						</li>
					</ul>
					...
					<ul className='kinder-schedule-list'>
						...
						<li>
							...
							<span>
								Погодинне відвідування коштує{' '}
								<strong>5% місячного абонементу</strong>
							</span>
							<span>
								Поденне відвідування коштує{' '}
								<strong>10% місячного абонементу</strong>
							</span>
						</li>
					</ul>
				</div>
			...
			<section className='faq'>
				<div className='container'>
					<h2 className='max-w-[500px] lowercase leading-[120%] text-center md:text-left'>
						<span className='block uppercase break-all 880:break-keep'>
							Найпоширеніші
						</span>
					...
					<div className='questions'>
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									Так, наш заклад дошкільної освіти має ліцензію МОН на
									здійснення освітньої діяльності з 2019 року.
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									До закладу приймаємо діток від 1,9-2-х років, але все
									індивідуально.
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									Навчання дітей здійснюється за програмою "Дитина".
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									На етапі дошкільної освіти ми формуємо такі компетентності:
									здоров'язбережувальну, комунікативну, ігрову,
									сенсорно-пізнавальну, природничо-екологічну,
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									Все досить індивідуально. Є діти, які швидко звикають, їм
									подобається в садочку і вони з першого дня готові залишитись
									на повний день. Є діти, яким потрібно більше часу. Для таких
									дітлахів розробляємо індивідуальні програми поступової
									адаптації з почасовим чи поденним відвідуванням. Педагоги та
									нянечки працюють з дітками при перших знайомствах
									індивідуально, що дозволяє зробити процес адаптації комфортним
									та веселим.
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									В одній віковій групі навчається до 12 діток.
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									В садочку навчаються діти у трьох вікових групах. З пʼяти
									років дітей переводять з садочку у нульовий клас початкової
									школи, який ми називаємо Preschool. <br />
									Тут дітки проходять усю програму базового компоненту
									дошкільної освіти, щодня займаються з вчителем з підготовки до
									школи, щодня мають заняття з іноземної мови. Також мають змогу
									відвідувати спортивні секції та творчі студії
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									В садочку повноцінне 4-х разове харчування: сніданок, обід,
									полуденок та вечеря.
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									Діти двічі на день ходять на прогулянку на власний дитячий
									майданчик, що розташований у парковій зоні неподалік.
								</p>
							</div>
						</button>
						...
						<button className='accordeon'>
							...
							<div className='panel'>
								<p className='acc-text'>
									Крім цікавих занять наші діти відвідують гуртки,
									майстер-класи, дискотеки, дні народження, пікніки, естафети,
									тематичні дні та веселі сезонні свята.
								</p>
							</div>
						</button>
					</div>
