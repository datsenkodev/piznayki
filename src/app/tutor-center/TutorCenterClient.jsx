...
export default function TutorCenterClient() {
	return (
		<m.main
			className='tutor'
			initial={{ opacity: 0 }}
				...
				<div className='container'>
					...
					<div className='hero-text__container'>
						...
						<p className='page-subtitle'>
							Ми прагнемо надати якісну, індивідуальну освіту та забезпечити
							повноцінний розвиток кожної особистості, формуємо знання та
							цінності, які стануть фундаментом для майбутнього успіху кожного
							здобувача освіти
						</p>
					...
					<div className='flex items-center 880:items-stretch flex-col 880:flex-row content-between gap-8 880:gap-10 lg:gap-40 mb-20 880:mb-36'>
						<div className='max-w-[80%] 880:max-w-[420px]'>
							...
							<p className='page-content__subtitle'>
								Період переходу від садочка до школи є стресовим і для дитини, і
								для батьків. Для того, щоб цей процес був максимально комфортним
								та легким, в мережі освітніх закладів ПІЗНАЙКИ діє PRESCHOOL -
								підготовка дитини до шкільного життя.
							</p>
							<p className='page-content__subtitle'>
								Наша програма PreSchool розрахована на дітей 4-6 років, які вже
								переросли формат дитячого садка, а для школи ще замаленькі.
							</p>
						</div>
						...
						<ul className='tutor-list blue-list'>
							...
							<li>
								Здатність фокусувати увагу, формулювати свої думки, слухати й
								розуміти інших
							</li>
							<li>
								Підвищення комунікабельності, здатності взаємодіяти з іншими
								людьми, бути частиною колективу.
							</li>
						</ul>
					</div>
					<div className='flex items-center 880:items-stretch flex-col 880:flex-row content-between gap-8 880:gap-10 lg:gap-40 mb-20 880:mb-36'>
						<h2 className='max-w-[80%] 880:max-w-[420px] leading-[120%] text-center 880:text-left'>
							Репетитор для{' '}
							<span className='text-[#EF6936]'>учнів 1-4 класів</span>
						</h2>
				...
				<Slider>
					<div className='advice-item bg-[#727EFC]'>
						...
						<ul className='tutor-cards-list'>
							...
							<li>
								Розвине здатність вільно говорити, читати і писати англійською
								мовою
							</li>
						</ul>
					</div>
					<div className='advice-item bg-[#FFB400]'>
						...
						<ul className='tutor-cards-list'>
							...
							<li>Допоможе підготуватися до іспитів і олімпіад</li>
							<li>
								Розвине здатність вільно говорити, читати і писати українською
								мовою
							</li>
						</ul>
					</div>
					<div className='advice-item bg-[#EF6936]'>
						...
						<ul className='tutor-cards-list'>
							...
							<li>
								Допоможе швидко і без стресу підготуватися до іспитів і олімпіад
							</li>
						</ul>
					</div>
					...
					<div className='advice-item bg-[#1A1E4E]'>
						...
						<ul className='tutor-cards-list'>
							<li>
								З інформаційними навичками діти зануряться у кібер майбутнє
							</li>
