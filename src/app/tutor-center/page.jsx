import { TutorCenterClient } from './TutorCenterClient'
import { generateTutorCenterJsonLd } from '@json-ld/tutor'
...
export default function TutorCenter() {
	const TutorCenterJsonLd = generateTutorCenterJsonLd()
	return (
		<>
			<script
				type='application/ld+json'
				dangerouslySetInnerHTML={{
					__html: JSON.stringify(TutorCenterJsonLd)
				}}
			/>
			<TutorCenterClient />
		</>
