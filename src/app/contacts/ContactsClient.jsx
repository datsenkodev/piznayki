				...
				<ul className='contacts-list'>
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('2')}
						>
							<input
								type='radio'
								id='second_location'
								name='drone'
								value='second_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('3')}
						>
							<input
								type='radio'
								id='third_location'
								name='drone'
								value='third_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('4')}
						>
							<input
								type='radio'
								id='fourth_location'
								name='drone'
								value='fourth_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('5')}
						>
							<input
								type='radio'
								id='fifth_location'
								name='drone'
								value='fifth_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('6')}
						>
							<input
								type='radio'
								id='sixth_location'
								name='drone'
								value='sixth_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('7')}
						>
							<input
								type='radio'
								id='seventh_location'
								name='drone'
								value='seventh_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
								Ліцей "Пізнайки-Розвивайки", Репетиторський центр для 5-11
								класів
							</span>
							<span className='flex gap-1 text-xs md:text-[1rem] text-[#646464]'>
								<Image src={pin} alt='Точка геолокації' />
					...
					<li>
						<label
							className='custom-radio'
							tabIndex={0}
							onClick={() => handleMarkerChange('8')}
						>
							<input
								type='radio'
								id='eight_location'
								name='drone'
								value='eight_location'
							/>
							<span className='radio'></span>
							<span className='text-[1rem] xs:text-xl font-bold'>
			...
			<section className='contacts-panel'>
				<div className='container'>
					...
					<Link
						...
						className='contacts-panel__link'
					>
