      ...
      <section className='hero'>
        <div className='container'>
          ...
          <div className='hero-image'>
            ...
            <Image aria-hidden src={triangle} alt='Трикутник' className='absolute' />
            <Image aria-hidden src={puzzleYellow} alt='Жовтий пазл' className='absolute ' />
            <Image aria-hidden src={puzzleOrange} alt='Помаранчевий пазл' className='absolute' />
          </div>
          ...
          <div className='max-w-[60rem] self-stretch grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 z-1 relative'>
            <Link
              ...
              <div className='flex items-center justify-center w-10 h-10 bg-white rounded-full ml-auto'>
                <svg
