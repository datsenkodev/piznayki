          ...
          <button className='accordeon'>
            ...
            <div className='panel'>
              <p className='acc-text'>
                Так, Школа «Пізнайки» є ліцензованою. Переглянути ліцензію можна тут. Школа надає
                учням документи державного зразка: після 4 класу — Свідоцтво про завершення
                початкової школи, після 9 класу — Свідоцтво про здобуття базової середньої освіти та
          ...
          <button className='accordeon'>
            ...
            <div className='panel'>
              <p className='acc-text'>
                ...
                тільки знання, а й розвивають емоційний інтелект та знають як застосувати  вміння 
                та навички у реальному житті.
              </p>
            </div>
          </button>
          ...
          <button className='accordeon'>
            ...
            <div className='panel'>
              <p className='acc-text'>
                ...
                як діти трохи освоїлися, ми проводимо зріз знань, навичок й умінь здобувачів
                освіти.  За результатами складається персоналізована програма, з урахуванням
                психологічних особливостей,  де кожна дитина , у рамках загальної програми навчання,
                може отримувати індивідуальні консультації та  покращувати свої інтелектуальні
                здібності.
              </p>
            </div>
          </button>
